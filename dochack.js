...
var NTI206579 = {size: 0,kind: 24,base: null,node: null,finalizer: null};
...
function nimCopy(dest_66427, src_66428, ti_66429) {
	var result_66619 = null;

		switch (ti_66429.kind) {
		case 21:
		case 22:
		case 23:
		case 5:
			if (!(is_fat_pointer_66401(ti_66429))) {
			result_66619 = src_66428;
			}
			else {
				result_66619 = [src_66428[0], src_66428[1]];
			}
			
			break;
		case 19:
			      if (dest_66427 === null || dest_66427 === undefined) {
        dest_66427 = {};
      }
      else {
        for (var key in dest_66427) { delete dest_66427[key]; }
      }
      for (var key in src_66428) { dest_66427[key] = src_66428[key]; }
      result_66619 = dest_66427;
    
			break;
		case 18:
		case 17:
			if (!((ti_66429.base == null))) {
			result_66619 = nimCopy(dest_66427, src_66428, ti_66429.base);
			}
			else {
			if ((ti_66429.kind == 17)) {
			result_66619 = (dest_66427 === null || dest_66427 === undefined) ? {m_type: ti_66429} : dest_66427;
			}
			else {
				result_66619 = (dest_66427 === null || dest_66427 === undefined) ? {} : dest_66427;
			}
			}
			nimCopyAux(result_66619, src_66428, ti_66429.node);
			break;
		case 24:
		case 4:
		case 27:
        ...
        if (dest_66427 === null || dest_66427 === undefined) {
          dest_66427 = new Array(src_66428.length);
        }
        else {
          dest_66427.length = src_66428.length;
        }
        result_66619 = dest_66427;
        for (var i = 0; i < src_66428.length; ++i) {
          result_66619[i] = nimCopy(result_66619[i], src_66428[i], ti_66429.base);
        }
      }
		...
		case 28:
			      if (src_66428 !== null) {
        result_66619 = src_66428.slice(0);
      }
...
function arrayConstr(len_66686, value_66687, typ_66688) {
		    var result = new Array(len_66686);
    for (var i = 0; i < len_66686; ++i) result[i] = nimCopy(null, value_66687, typ_66688);
    return result;
...
function chckIndx(i_66705, a_66706, b_66707) {
			var Tmp1;

	var result_66708 = 0;

	BeforeRet: do {
			if (!(a_66706 <= i_66705)) Tmp1 = false; else {				Tmp1 = (i_66705 <= b_66707);			}		if (Tmp1) {
		result_66708 = i_66705;
		break BeforeRet;
		}
		else {
		raiseIndexError(i_66705, a_66706, b_66707);
		}
...
function chckRange(i_66724, a_66725, b_66726) {
			var Tmp1;

	var result_66727 = 0;

	BeforeRet: do {
			if (!(a_66725 <= i_66724)) Tmp1 = false; else {				Tmp1 = (i_66724 <= b_66726);			}		if (Tmp1) {
		result_66727 = i_66724;
		break BeforeRet;
		}
		else {
		raiseRangeError();
...
function nimMax(a_66021, b_66022) {
		var Tmp1;
...
function nimMin(a_66003, b_66004) {
		var Tmp1;
...
function is_fat_pointer_66401(ti_66403) {
	var result_66404 = false;

	BeforeRet: do {
		result_66404 = !((ConstSet1[ti_66403.base.kind] != undefined));
		break BeforeRet;
	} while (false);
...
function nimCopyAux(dest_66432, src_66433, n_66435) {
		switch (n_66435.kind) {
		case 0:
			break;
		case 1:
			      dest_66432[n_66435.offset] = nimCopy(dest_66432[n_66435.offset], src_66433[n_66435.offset], n_66435.typ);
    
			break;
		case 2:
			    for (var i = 0; i < n_66435.sons.length; i++) {
      nimCopyAux(dest_66432, src_66433, n_66435.sons[i]);
    }
		...
		case 3:
			      dest_66432[n_66435.offset] = nimCopy(dest_66432[n_66435.offset], src_66433[n_66435.offset], n_66435.typ);
      for (var i = 0; i < n_66435.sons.length; ++i) {
        nimCopyAux(dest_66432, src_66433, n_66435.sons[i][1]);
      }
...
function raiseIndexError(i_64643, a_64644, b_64645) {
		...
		Tmp1 = (makeNimstrLit("index ") || []).concat(cstrToNimstr((i_64643)+"") || [],makeNimstrLit(" not in ") || [],cstrToNimstr((a_64644)+"") || [],makeNimstrLit(" .. ") || [],cstrToNimstr((b_64645)+"") || []);
		}
		
		e_64802.message = nimCopy(null, Tmp1, NTI43040);
		e_64802.parent = null;
...
function extract_items_205339(x_205341, heading_205342, items_205345, items_205345_Idx) {
	...
	BeforeRet: do {
		...
		L2: do {
			...
			var i_205374 = 0;
			F.line = 2706;
			var colontmp__206475 = 0;
			F.line = 83;
			colontmp__206475 = (x_205341.kids != null ? x_205341.kids.length : 0);
			F.line = 2707;
			var i_206476 = 0;
			L3: do {
				F.line = 2708;
					L4: while (true) {
					if (!(i_206476 < colontmp__206475)) break L4;
						F.line = 83;
						i_205374 = i_206476;
						F.line = 84;
			...
			L5: do {
				...
				var i_205394 = 0;
				F.line = 2706;
				var colontmp__206480 = 0;
				F.line = 86;
				colontmp__206480 = (x_205341.kids != null ? x_205341.kids.length : 0);
				F.line = 2707;
				var i_206481 = 0;
				L6: do {
					F.line = 2708;
						L7: while (true) {
						if (!(i_206481 < colontmp__206480)) break L7;
							F.line = 86;
							i_205394 = i_206481;
							F.line = 87;
	...
	framePtr = F;
		...
		L1: do {
			...
			L2: do {
				F.line = 4;
					L3: while (true) {
					if (!(i_206498 < (kids_205024 != null ? kids_205024.length : 0))) break L3;
						F.line = 12;
						k_205056 = kids_205024[chckIndx(i_206498, 0, kids_205024.length+0-1)-0];
						F.line = 13;
						result_205025.appendChild(k_205056);
						F.line = 6;
						i_206498 = addInt(i_206498, 1);
					}
			} while(false);
		} while(false);
	framePtr = F.prev;
...
function sys_fatal_57062(message_57066) {
	var F={procname:"sysFatal.sysFatal",prev:framePtr,filename:"fatal.nim",line:0};
	framePtr = F;
		F.line = 34;
		var e_57207 = null;
		F.line = 37;
		e_57207 = {m_type: NTI46650, parent: null, name: null, message: null, trace: null, raiseId: 0, up: null};
		F.line = 38;
		e_57207.message = nimCopy(null, message_57066, NTI43040);
		F.line = 39;
...
function uncovered_205940(x_205942) {
	...
	BeforeRet: do {
		...
		L3: do {
			...
			var i_205982 = 0;
			F.line = 2706;
			var colontmp__206510 = 0;
			F.line = 197;
			colontmp__206510 = (x_205942.kids != null ? x_205942.kids.length : 0);
			F.line = 2707;
			var i_206511 = 0;
			L4: do {
				F.line = 2708;
					L5: while (true) {
					if (!(i_206511 < colontmp__206510)) break L5;
						F.line = 197;
						i_205982 = i_206511;
						F.line = 198;
	...
	framePtr = F;
		...
		result_206021 = news_206020;
			...
			L1: do {
				...
				var i_206042 = 0;
				F.line = 2706;
				var colontmp__206504 = 0;
				F.line = 207;
				colontmp__206504 = (news_206020.kids != null ? news_206020.kids.length : 0);
				F.line = 2707;
				var i_206505 = 0;
				L2: do {
					F.line = 2708;
						L3: while (true) {
						if (!(i_206505 < colontmp__206504)) break L3;
							F.line = 207;
							i_206042 = i_206505;
							F.line = 208;
...
function build_toc_206063(orig_206065, types_206067, procs_206068) {
	...
	framePtr = F;
		...
		L1: do {
			...
			var i_206493 = 0;
			F.line = 186;
			var l_206494 = (types_206067 != null ? types_206067.length : 0);
			L2: do {
				F.line = 187;
					L3: while (true) {
					if (!(i_206493 < l_206494)) break L3;
						F.line = 212;
						t_206214 = types_206067[chckIndx(i_206493, 0, types_206067.length+0-1)-0];
						F.line = 213;
						...
						L4: do {
							...
							var i_206490 = 0;
							F.line = 186;
							var l_206491 = (procs_206068 != null ? procs_206068.length : 0);
							L5: do {
								F.line = 187;
									L6: while (true) {
									if (!(i_206490 < l_206491)) break L6;
										F.line = 215;
										p_206235 = procs_206068[chckIndx(i_206490, 0, procs_206068.length+0-1)-0];
										...
										F.line = 189;
										i_206490 = addInt(i_206490, 1);
										if (!(((procs_206068 != null ? procs_206068.length : 0) == l_206491))) {
										F.line = 190;
										failed_assert_impl_57255(makeNimstrLit("/Users/travis/build/nim-lang/Nim/lib/system/iterators.nim(190, 11) `len(a) == L` the length of the seq changed while iterating over it"));
										}
						...
						if (!(((types_206067 != null ? types_206067.length : 0) == l_206494))) {
						F.line = 190;
						failed_assert_impl_57255(makeNimstrLit("/Users/travis/build/nim-lang/Nim/lib/system/iterators.nim(190, 11) `len(a) == L` the length of the seq changed while iterating over it"));
						}
...
function to_html_205424(x_205426, is_root_205427) {
	...
	BeforeRet: do {
		...
		L2: do {
			...
			var k_205614 = null;
			F.line = 183;
			var colontmp__206517 = null;
			F.line = 115;
			colontmp__206517 = x_205426.kids;
			F.line = 185;
			var i_206519 = 0;
			F.line = 186;
			var l_206520 = (colontmp__206517 != null ? colontmp__206517.length : 0);
			L3: do {
				F.line = 187;
					L4: while (true) {
					if (!(i_206519 < l_206520)) break L4;
						F.line = 115;
						k_205614 = colontmp__206517[chckIndx(i_206519, 0, colontmp__206517.length+0-1)-0];
						F.line = 116;
						...
						F.line = 189;
						i_206519 = addInt(i_206519, 1);
						if (!(((colontmp__206517 != null ? colontmp__206517.length : 0) == l_206520))) {
						F.line = 190;
						failed_assert_impl_57255(makeNimstrLit("/Users/travis/build/nim-lang/Nim/lib/system/iterators.nim(190, 11) `len(a) == L` the length of the seq changed while iterating over it"));
						}
			...
			F.line = 49;
				...
				if (!((str_index_204085 < (str_204073 != null ? str_204073.length : 0)) && (pat_index_204087 < (pattern_204072 != null ? pattern_204072.length : 0)))) break L2;
					L3: do {
						...
						F.line = 67;
						score_204089 = Math.trunc(Math.floor((5.0000000000000000e-01 * score_204089)));
						F.line = 68;
						pat_index_204087 = 0;
						F.line = 69;
						str_index_204085 = addInt(str_index_204085, 1);
...
function dosearch_206557(value_206559) {
	...
	var result_206560 = null;

	var F={procname:"dochack.dosearch",prev:framePtr,filename:"dochack.nim",line:0};
	framePtr = F;
		if (((db_206523[0] != null ? db_206523[0].length : 0) == 0)) {
		F.line = 272;
		var stuff_206566 = null;
		F.line = 273;
    ...
    stuff_206566 = doc.documentElement;
    
		F.line = 286;
		db_206523[0] = nimCopy(null, stuff_206566.getElementsByClassName("reference"), NTI86305);
		F.line = 287;
		contents_206525[0] = nimCopy(null, [], NTI206579);
		L1: do {
			F.line = 288;
			...
			var i_207043 = 0;
			F.line = 186;
			var l_207044 = (db_206523[0] != null ? db_206523[0].length : 0);
			L2: do {
				F.line = 187;
					L3: while (true) {
					if (!(i_207043 < l_207044)) break L3;
						F.line = 288;
						ahref_206814 = db_206523[0][chckIndx(i_207043, 0, db_206523[0].length+0-1)-0];
						F.line = 289;
						if (contents_206525[0] != null) { contents_206525[0].push(ahref_206814.getAttribute("data-doc-search-tag")); } else { contents_206525[0] = [ahref_206814.getAttribute("data-doc-search-tag")]; };
						F.line = 189;
						i_207043 = addInt(i_207043, 1);
						if (!(((db_206523[0] != null ? db_206523[0].length : 0) == l_207044))) {
						F.line = 190;
						failed_assert_impl_57255(makeNimstrLit("/Users/travis/build/nim-lang/Nim/lib/system/iterators.nim(190, 11) `len(a) == L` the length of the seq changed while iterating over it"));
						}
		...
		F.line = 291;
		result_206560 = tree_205020(makeNimstrLit("DIV"), []);
		F.line = 292;
		set_class_205103(result_206560, makeNimstrLit("search_results"));
		F.line = 293;
		var matches_206844 = [];
		L4: do {
			F.line = 294;
			...
			F.line = 294;
			colontmp__207050 = (db_206523[0] != null ? db_206523[0].length : 0);
			F.line = 2707;
			var i_207051 = 0;
			L5: do {
				F.line = 2708;
					...
					if (!(i_207051 < colontmp__207050)) break L6;
						...
						L7: do {
							F.line = 295;
							var c_206858 = contents_206525[0][chckIndx(i_206857, 0, contents_206525[0].length+0-1)-0];
							...
							F.line = 301;
							nimCopy(colontmp__207060, fuzzy_match_204070(value_206559, c_206858), NTI204074);
							F.line = 301;
							...
							if (matched_206860) {
							F.line = 303;
							if (matches_206844 != null) { matches_206844.push({Field0: db_206523[0][chckIndx(i_206857, 0, db_206523[0].length+0-1)-0], Field1: score_206859}); } else { matches_206844 = [{Field0: db_206523[0][chckIndx(i_206857, 0, db_206523[0].length+0-1)-0], Field1: score_206859}]; };
							}
		...
		F.line = 310;
		add_205085(result_206560, tree_205020(makeNimstrLit("B"), [text_205120(makeNimstrLit("no search results"))]));
		}
		else {
			F.line = 312;
			add_205085(result_206560, tree_205020(makeNimstrLit("B"), [text_205120(makeNimstrLit("search results"))]));
			F.line = 313;
			add_205085(result_206560, ul_206825);
		}
		
	framePtr = F.prev;

	return result_206560;
...
function search() {
		...
		function wrapper_206991() {
			...
			framePtr = F;
				...
				F.line = 325;
				var results_207000 = dosearch_206557(value_206994);
				F.line = 326;
